...
$query= "SELECT * FROM mathrix where mathrix_id='$search'";
...
<td><font type="Constantia" size="4" color="black">Events:</font></td><td>
 <input type="checkbox" name="dumbc" value="1" id="dumbc" <?php if ($val6 == 1) echo "checked=checked";?>/> <font type="Constantia" size="4" color="black">D-structs <br />
 <input type="checkbox" name="mathsketching" value="1" id="mathsketching"  <?php if ($val7 == 1) echo "checked=checked";?>/> <font type="Constantia" size="4" color="black">math model <br />
 <input type="checkbox" name="paperpresentation" id="paperpresentation" value="1" <?php if ($val8 == 1) echo "checked=checked";?> /><font type="Constantia" size="4" color="black"> Bug Master <br />
